...
departures = {"/departure/msk/": "Из Москвы", "/departure/spb/": "Из Петербурга", "/departure/nsk/": "Из Новосибирска", "/departure/ekb/": "Из Екатеринбурга",
       "/departure/kazan/": "Из Казани"}
...
tours_list = [val for val in tours.values()]
